 ...
 * Onboarding3Fragment
 *
 *  Presents the user with "What is a worthwhile trip" (info only and next button)
 *
...
public class Onboarding3Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_what_is_worthwile_trip_onboarding_3, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.nextButton:
                ...
                Onboarding3ProductivityFragment mfragment = Onboarding3ProductivityFragment.newInstance("","");
