 ...
 *
 *   Adapter to draw a list of trips (init location ,end location, time and an indicator of if the
 *   trip was already validated by the user)
 *
 ...
 */
public class ListMyTripsAdapter extends ArrayAdapter<FullTripDigest> {
    ...
    private static class ViewHolder {
        ...
        TextView fromPlace;
        TextView toPlace;
        ImageView hasBeenValidated;
        TextView fromTimestamp;
        TextView toTimestamp;

    }

    public ListMyTripsAdapter(ArrayList<FullTripDigest> data, Context context) {
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.mytrips_listitem_frag, parent, false);
            ...
            viewHolder.hasBeenValidated = (ImageView) convertView.findViewById(R.id.hasBeenValidatedImageView);
            ...
            if(!dataModel.isValidated()){
                viewHolder.hasBeenValidated.setImageResource(R.drawable.mytrips_navigation_warning);
            }else{
                viewHolder.hasBeenValidated.setImageResource(R.drawable.mytrips_navigation_confirmation);
            }
