 ...
 * LanguageListAdapter
 *
 *  Adapter used to draw the list of languages selectable by the user.
 *
...
public class LanguageListAdapter extends ArrayAdapter<String> {
    ...
    public LanguageListAdapter(@NonNull Context context, @SuppressLint("SupportAnnotationUsage") @LayoutRes ArrayList<String> list, AdapterCallback adapterCallback, int selectedOption) {
        ...
        if(listItem == null){
            ...
            if(optionsList.size() == 1){
                ...
                if (position == 0) {
                    ...
                    listItem = LayoutInflater.from(mContext).inflate(R.layout.top_languages_list_item_layout, parent, false);
        ...
        listItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position != selectedOption){
                    ...
                    /** warn activity/fragment so that it could act on this change (save selected option) **/
