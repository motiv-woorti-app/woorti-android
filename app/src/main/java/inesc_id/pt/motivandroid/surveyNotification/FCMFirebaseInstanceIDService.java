...
public class FCMFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private static final String TAG = LogsUtil.INIT_LOG_TAG + "FCMFirebaseIDService";
    ...
    public void onTokenRefresh() {
        ...
        FirebaseTokenManager.getInstance(getApplicationContext()).onAuthChangedFCMToken(refreshedToken);
