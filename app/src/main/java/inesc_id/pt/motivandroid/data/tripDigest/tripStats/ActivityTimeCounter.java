 ...
 * ActivityTimeCounter
 *
 * Data structure to keep track of the activities done by the user throughout a trip.
 *
 ...
 */
public class ActivityTimeCounter {
    ...
    public ActivityTimeCounter(long timeCounter, ArrayList<ActivityLeg> legActivities) {
