...
/**
 *
 * StatsFromTimeIntervalStructForUser
 *
 * Contains trip metrics calculated for a given time interval for the user
 *
 ...
 */
public class StatsFromTimeIntervalStructForUser implements Serializable{

    public StatsFromTimeIntervalStructForUser() {
    }
