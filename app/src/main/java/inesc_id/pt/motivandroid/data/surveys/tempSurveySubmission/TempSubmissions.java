 ...
 */
public class TempSubmissions implements Serializable{
    ...
    public TempSubmissions(long answerDate, ArrayList<Answer> answers, String uid, long triggeredDate, Trigger trigger) {
