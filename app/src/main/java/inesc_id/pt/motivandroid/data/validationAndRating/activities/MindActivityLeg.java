 ...
 */
public class MindActivityLeg extends ActivityLeg implements Serializable{

    public MindActivityLeg(String activityText, String textCode, int intCode, boolean selected) {
    ...
    @Override
    public int getIcon() {
        return keys.mindIconsDrawables[getIntCode()];
    }
