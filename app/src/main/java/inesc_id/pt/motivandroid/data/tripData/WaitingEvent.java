...
import inesc_id.pt.motivandroid.data.pointSystem.WaitingEventScored;

/**
 * WaitingEvent
 *
 *   Subclass of FullTripPart. Data structure of a Waiting event
 *
...
public class WaitingEvent extends FullTripPart implements Serializable{
    ...
    public WaitingEventScored getWaitingEventScored(Context context) {

        if(waitingEventScored == null){
            waitingEventScored = new WaitingEventScored(context);
        }

        return waitingEventScored;
    }

    public void setWaitingEventScored(WaitingEventScored waitingEventScored) {
        this.waitingEventScored = waitingEventScored;
    }

    WaitingEventScored waitingEventScored;
