 ...
 * MyContextWrapper
 *
 *  Workaround to ensure that the previously chosen app language is set.
 *
...
public class MyContextWrapper extends ContextWrapper {
    ...
    public static ContextWrapper wrap(Context context) {
        ...
        if(userSettingStateWrapper != null && userSettingStateWrapper.getUserSettings().getLang() != null){
            ...
            Log.e("MyContextWrapper", "getLang: " + userSettingStateWrapper.getUserSettings().getLang());
            Log.e("MyContextWrapper", "getLangSmartphoneFromWoortiID : " + Language.getLanguageSmartphoneFromWoortiID(userSettingStateWrapper.getUserSettings().getLang()));
